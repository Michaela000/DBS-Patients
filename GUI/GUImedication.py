...
class MedicationDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        lay1.addWidget(self.lineEditLevodopaCarbidopa)
        lay1.addStretch()
        ...
        lay2.addWidget(self.lineEditLevodopaCarbidopaCR)
        lay2.addStretch()
        ...
        lay3.addWidget(self.lineEditEntacapone)
        lay3.addStretch()
        ...
        lay4.addWidget(self.lineEditTolcapone)
        lay4.addStretch()
        ...
        lay5.addWidget(self.lineEditPramipexole)
        lay5.addStretch()
        ...
        lay6.addWidget(self.lineEditRopinirole)
        lay6.addStretch()
        ...
        lay7.addWidget(self.lineEditRotigotine)
        lay7.addStretch()

        self.subj_Selegiline_oral = QLabel('Selegiline oral:\t\t')
        self.lineEditSelegilineOral = QLineEdit()
        lay8 = QHBoxLayout()
        lay8.addWidget(self.subj_Selegiline_oral)
        lay8.addWidget(self.lineEditSelegilineOral)
        lay8.addStretch()

        self.subj_Selegiline_sublingual = QLabel('Selegiline sublingual:\t')
        self.lineEditSelegilineSublingual = QLineEdit()
        lay9 = QHBoxLayout()
        lay9.addWidget(self.subj_Selegiline_sublingual)
        lay9.addWidget(self.lineEditSelegilineSublingual)
        lay9.addStretch()
        ...
        lay10.addWidget(self.lineEditRasagiline)
        lay10.addStretch()
        ...
        lay11.addWidget(self.lineEditAmantadine)
        lay11.addStretch()
        ...
        lay12.addWidget(self.lineEditApomorphine)
        lay12.addStretch()
        ...
        lay13.addWidget(self.lineEditPiribedil)
        lay13.addStretch()
        ...
        lay14.addWidget(self.lineEditSafinamid)
        lay14.addStretch()
        ...
        lay15.addWidget(self.lineEditOpicapone)
        lay15.addStretch()
        ...
        lay16.addWidget(self.lineEditOther)
        lay16.addStretch()
